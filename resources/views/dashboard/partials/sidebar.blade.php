...
<div class="fixed left-0 top-0 w-64 h-full bg-[#f8f4f3] p-4 z-50 sidebar-menu transition-transform">
    ...
    <ul class="mt-4">
        ...
        <li class="mb-1 group">
            <a href="/dashboard" class="{{ request()->is('dashboard') ? 'bg-gray-950 text-white' : '' }} flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100">
        ...
        <li class="mb-1 group">
            <a href="/dashboard/category" class="{{ request()->is('dashboard/category*') ? 'bg-gray-950 text-white' : '' }} flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100">
                <i class="fa-solid fa-list"></i> <span class="text-sm ml-3">Category</span>
            </a>
        </li>
